...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
	...
	# Answer: if it were included in a non-matching string
  end
  ...
  # Answer: the number of characters they can match is only limited
  # by the string they operate on.
  ...
  # Answer: same as the difference between "Whatever you have out of
  # cheese or wine, I'll have it." and "I'll have cheese if you have
  # it, and also if you have wine I'll have that too."
