...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
	...
	# Answer: because with Dog6.new we're calling the initialize
	# method in the Dog6 class and should be supplying one argument
	# to it, whereas Dog6.new supplies none.
  end
