...
class AboutClassMethods < Neo::Koan
  ...
  # Answer: I would prefer the first, since it has class and 
  # instance methods visible in one place. I would use the other
  # if I wanted to wanted to keep the parent class separate, such as
  # has been done with these RubyKoans scripts.

  # ------------------------------------------------------------------

  def test_theres_an_easy_way_to_call_class_methods_from_instance_methods
    fido = Dog.new
