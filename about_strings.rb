...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
	...
	# Answer: to ensure the updated value is used throughout.
	# Alternatively, to avoid creating a new object.
  end
  ...
  def test_double_quoted_string_interpret_escape_characters
	...
	# This one tripped me up once when parsing an email. Remember.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
	...
	# Answer: no, the preceding tests already showed 0-indexing.
  end
