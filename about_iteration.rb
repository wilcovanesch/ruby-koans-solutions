...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
	...
	# Answer: inject executes a block for two arguments, where one 
	# is a running tally of the result and where one is each 
	# sequential item in the collection.
	# result: (((0 + 2) + 3) + 4) = 9
	# result2: (((1 * 2) * 3) * 4) = 24
  end
  ...
  # Answer: because working on the file in a block will automatically
  # close the file when the block is done working on it.
end
