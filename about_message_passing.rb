...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
	...
	# Answer: so that when you define your own send method in a
	# class it doesn't override the standard library send method.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
	# Answer: calls to method_missing would use the redefined
	# behaviour.
	#	
    # NOTE:
    #
